...
if (isset($_POST['reactivate'])) {
  ...
  if ($rowUserAdmin['numrows'] > 0) {
    ...
    try {
      ...
      $url = 'http://localhost/palengke_go/reactivate.php?code=' . $codeUserAdmin . '&user=' . $rowUserAdmin['id'];
      $message = "
				<html>
          <head>
                          ...
                          <tr>
                            <td>
                              <center>
                                ...
                                <p><h2>Reactivate Account Request</h2></p>
                              </center>
                            </td>
                          </tr>
                        </table>
                      ...
                      <td class='wrapper'>
                        <table border='0' cellpadding='0' cellspacing='0'>
                          <tr>
                            <td>
                              <p>Greetings,</p>
                              <p>We have received a account reactivation request from the email address $email on PalengkeGo Website.</p>
                              <p>Click on the button below to reactivate your account.</p>
                              <p><center><a href=" . $url . " target='_blank' style='width:80%; display: inline-block; color: #ffffff; background-color: #59bd99; border: solid 1px #59bd99; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #59bd99;'>Reactivate Account</a></center></p>
      ...
      try {
        ...
        $mailUserAdmin->Subject = 'Account Reactivation from PalengkeGo! Mariveles Public Market App';
        $mailUserAdmin->Body    = $message;

        $mailUserAdmin->send();

        $_SESSION['success'] = 'Success!';
        $_SESSION['message'] = 'Account reactivation link sent.';
    ...
    if ($rowStallholder['numrows1'] > 0) {
      ...
      try {
        ...
        $url = 'http://localhost/palengke_go/reactivate.php?code=' . $codeStallholder . '&user=' . $rowStallholder['id'];
        $message = "
          <html>
            <head>
              <meta name='viewport' content='width=device-width' />
                          ...
                          <table border='0' cellpadding='0' cellspacing='0'>
                            <tr>
                              <td>
                                <center>
                                  <img src='https://i.ibb.co/dpq1yhw/Latest-Palengke-Go-Set-Side.png' alt='palengke_go_logo'>
                                  <p><h2>Account Reactivate Request</h2></p>
                                </center>
                              </td>
                            </tr>
                          </table>
        ...
        try {
          ...
          $mailStallholder->Subject = 'Account Reactivation from PalengkeGo! Mariveles Public Market App';
