<!-- ADD -->
<div class="modal fade" id="modalAddStallholder" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-primary">
      <!-- HEADER -->
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Add New Stallholder</h5>
      ...
      <div class="modal-body">
        <div class="card-body p-0">
          <form class="form-horizontal" id="formAddStallholder" action="includes/stallholders_crud.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default " data-dismiss="modal"><i class="fa fa-close"></i>
          Close</button>
        <button type="submit" form="formAddStallholder" class="btn btn-primary " name="add_stallholder"><i class="fa fa-save"></i>
          Save</button>
      </div>
    </div>
  </div>
...
<!-- EDIT -->
<div class="modal fade" id="modalEditStallholder" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-success">
      <!-- HEADER -->
      <div class="modal-header bg-success">
        <h5 class="modal-title">Edit Stallhodler</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formEditStallholder" method="POST" action="includes/stallholders_crud.php" enctype="multipart/form-data">
          <!-- USER ID -->
            ...
            <div class="tab-pane" id="editAccountInfo">
              ...
              <div id="containerEditAccountInfo">
                ...
                <p class="text-success text-bold ">
                  ...
                  Proceeding with this operation will edit this stallholder's account and personal details.
                </p>
              </div>
            </div>
            <div class="card-header p-0 border-0 w-100">
              <ul class="nav nav-pills p-0 m-0 d-flex justify-content-between align-items-center">
                <li class="nav-item">
                  <a id="btnEditPersonalInfo" class="nav-link active-link bg-main text-white" href="#editPersonalInfo" data-toggle="tab">
                    <span class="fa fa-angle-double-left mr-1 text-white"></span>
                    <span class="text-white">Previous</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a id="btnEditAccountInfo" class="nav-link bg-main text-white" href="#editAccountInfo" data-toggle="tab">
                    <span class="text-white">Next</span>
                    <span class="fa fa-angle-double-right ml-1 text-white"></span>
                  </a>
                </li>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="formEditStallholder" class="btn btn-success " name="edit_stallholder"><i class="fa fa-save"></i>
          Update</button>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modalEditUsername" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-success">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formEditUsername" method="POST" action="includes/stallholders_crud.php" enctype="multipart/form-data">
          <!-- USER ID -->
          <input type="hidden" class="stallholder-id" id="stallholderId" name="stallholder_id" hidden>
          <!-- USERNAME -->
          <div class="form-group row mb-2">
          ...
          <p class="text-success text-bold m-0">
            <i class="fa fa-edit pr-1"></i>
            Proceeding with this operation will edit this stallholder's username.
          </p>
        </form>
      </div>
      <!-- FOOTER -->
      <div class="modal-footer">
        <button type="button" class="btn btn-default " data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
        <button type="submit" form="formEditUsername" class="btn btn-success " name="edit_stallholder_username"><i class="fa fa-save"></i> Update</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modalEditEmail" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-success">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formEditEmail" method="POST" action="includes/stallholders_crud.php" enctype="multipart/form-data">
          <!-- USER ID -->
          <input type="hidden" class="stallholder-id" id="stallholderId" name="stallholder_id" hidden>
          <!-- EMAIL -->
          <div class="form-group">
            ...
            <!-- EMAIL -->
            <div class="input-group mb-3">
              <input type="email" class="form-control edit-email" id="editEmail" name="edit_email" placeholder="Edit Email">
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fa fa-envelope"></span>
                </div>
            ...
            <p class="text-success text-bold m-0">
              <i class="fa fa-edit pr-1"></i>
              Proceeding with this operation will edit this stallholder's email.
            </p>
          </div>
        </form>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="formEditEmail" class="btn btn-success btn-flat" name="edit_stallholder_email"><i class="fa fa-save"></i> Update</button>
      </div>
    </div>
  </div>
</div>
...
<!-- DELETE -->
<div class="modal fade" id="modalDeleteStallholder">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-danger">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formDeleteStallholder" method="POST" action="includes/stallholders_crud.php" enctype="multipart/form-data">
          <!-- USER ID -->
          <input type="hidden" class="stallholder-id" id="stallholderId" name="stallholder_id" hidden>
          <div class="text-center">
            <p>Are you sure you want to delete this stallholder?</p>
            <!-- FULL NAME -->
            <h2 class="bold full-name" id="full-name" name="full-name"></h2>
            <p class="text-danger text-bold">
              <i class="fa fa-exclamation-triangle"></i>
              Proceeding with this operation will erase the data of this stallholder, their vendors, and helpers, as well as the contents of assigned and unassigned stalls and their products.
            </p>
          </div>
        </form>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default " data-dismiss="modal"><i class="fa fa-close"></i>
          Close</button>
        <button type="submit" form="formDeleteStallholder" class="btn btn-danger " name="delete_stallholder"><i class="fa fa-trash"></i>
          Delete</button>
      </div>
    </div>
  </div>
...
<!-- VALID ID -->
<div class="modal fade" id="modalValidIDStallholder" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-info">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="editStallholderValidId" method="POST" action="includes/stallholders_crud.php" enctype="multipart/form-data">
          <!-- STALLHOLDER ID -->
          <div class="d-flex flex-column">
            <p class="text-center pb-2 mb-0">Change stallholder valid id for
              <span class="full-name" id="full-name"></span>
              ?
            </p>
          ...
          <p class="text-info text-bold m-0">
            ...
            Proceeding with this operation will change this stallholder's valid id.
          </p>
        </form>
      </div>
      <!-- FOOTER -->
      <div class="modal-footer">
        <button type="button" class="btn btn-default " data-dismiss="modal"><i class="fa fa-close"></i>
          Close</button>
        <button type="submit" form="editStallholderValidId" class="btn btn-info " name="update_stallholder_valid_id"><i class="fa fa-check-square-o"></i>
          Update</button>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modalViewVendorHelper">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-info">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formViewVendorHelper" method="GET" action="includes/stallholders_crud.php" enctype="multipart/form-data">
          <!-- USER ID -->
          <input type="hidden" class="stallholder-id" id="stallholderId" name="id" hidden>
...
<div class="modal fade" id="modalReactivateAccount">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-info">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formReactivateUser" method="POST" action="includes/stallholders_crud.php">
          <!-- STALLHOLDER ID -->
          <input type="hidden" class="stallholder-id" id="stallholderId" name="stallholder_id" hidden>
          <div class="text-center">
            ...
            <p class="text-info text-bold m-0">
              ...
              Proceeding with this operation will reactivate this stallholder's account and will be granted access to PalengkeGO.
            </p>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default " data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
        <button type="submit" form="formReactivateUser" class="btn btn-info " name="reactivate_stallholder"><i class="fa fa-check"></i>
          Reactivate</button>
      </div>
    </div>
  </div>
...
<!-- DEACTIVATE -->
<div class="modal fade" id="modalDeactivateAccount">W
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-danger">
      <!-- HEADER -->
      <div class="modal-header bg-danger">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formDeactivateUser" method="POST" action="includes/stallholders_crud.php">
          <!-- STALLHOLDER ID -->
          <input type="hidden" class="stallholder-id" id="stallholderId" name="stallholder_id" hidden>
          <div class="text-center">
            ...
            <p class="text-danger text-bold m-0">
              ...
              Proceeding with this operation will make this stallholder's account unable to login to PalengkeGO.
            </p>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default " data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
        <button type="submit" form="formDeactivateUser" class="btn btn-danger " name="deactivate_stallholder">
