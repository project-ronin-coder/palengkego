  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-success">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form id="formEditStall" method="POST" action="includes/stallsAssigned_crud.php" enctype="multipart/form-data">
          <!-- STALL ID -->
        ...
        <form id="formRedirectToStallholder" action="includes/stallsAssigned_crud.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
          <!-- STALL ID -->
...
<!-- UNASSIGN -->
<div class="modal fade" id="unassignStall">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-danger">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formDeleteStall" method="POST" action="includes/stallsAssigned_crud.php" enctype="multipart/form-data">
          <!-- STALL ID -->
          <input type="hidden" class="stall-id" id="stallSection" name="stall_id" hidden>
          <div class="text-center">
            <p>
              Are you sure you want to unassign this stall to Section:
              <span class="text-bold stall-section"></span> ?
            </p>
            <!-- STALL NAME -->
            ...
            <p class="text-danger text-bold">
              ...
              Proceeding with this operation will unassign this stall to PalengkeGO, making it unsearchable for users.
            </p>
          </div>
        </form>
      </div>
...
<div class="modal fade" id="photoStall">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-info">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="editStallPhoto" method="POST" action="includes/stallsAssigned_crud.php" enctype="multipart/form-data">
          <!-- STALL PHOTO -->
          <div class="d-flex flex-column">
            ...
            <img class="img-thumbnail mx-auto d-block mb-2" id="newStallPhoto" src="">
            <!-- ID -->
          ...
          <div class="input-group">
            <div class="custom-file d-flex">
              ...
              <label class="custom-file-label" for="stall-photo">Choose a stall photo</label>
            </div>
          </div>
...
<div class="modal fade" id="viewProducts">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content border-2 border-info">
      ...
      <div class="modal-body">
        <!-- FORM -->
        <form class="form-horizontal" id="formViewProducts" action="includes/stallsAssigned_crud.php" method="get" enctype="multipart/form-data">
          <!-- ID -->
          <input type="hidden" class="stall-id" id="stall-id" name="stall_id" hidden>
          <!-- STALL PHOTO -->
