...
<head>
  ...
  <?php include 'assets/css/style_stallholders.php'; ?>
</head>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>List of Stallholders</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item "><a href="dashboard.php">Home</a></li>
                <li class="breadcrumb-item active">List of Stallholders</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="my-3 mx-3 d-flex justify-content-start align-items-center">
                  <button data-toggle="modal" data-target="#addStallholder" class="btn-add btn btn-primary">
                ...
                <hr class="m-0">
                <div class="card-body">
                  <table id="stallholders-table" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <!-- TABLE HEAD -->
                        <th>Valid ID</th>
                    ...
                    <tbody>
                      <?php include 'fetch/_stallholders_fetch.php' ?>
                    </tbody>
                    <tfoot>
                    </tfoot>
                  </table>
    ...
    <!-- MODAL -->
    <?php include 'dist/modal_stallholders.php' ?>
  </div>
  <!-- SCRIPTS -->
  ...
  <script>
    ...
    $(function() {
      ...
      $(document).on("click", ".btn-add", function(e) {
        e.preventDefault();
        $("#modalAddStallholder").modal("show");
      });

      // FOR EDIT
      $(document).on("click", ".btn-edit", function(e) {
        e.preventDefault();
        $("#modalEditStallholder").modal("show");
        var id = $(this).data("id");
        getRow(id);
      });
      ...
      $(document).on("click", ".btn-delete", function(e) {
        e.preventDefault();
        $("#modalDeleteStallholder").modal("show");
        var id = $(this).data("id");
        getRow(id);
      });
